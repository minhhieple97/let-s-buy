          ...
          {({ open }) => {
            ...
            return (
              ...
              >
                ...
                <span>{value.length > 0 ? 'Change cover' : 'Upload a cover'}</span>
              </button>
            );
          }}
        </CldUploadWidget>
      ...
      <div>
        <div className="mb-4 flex items-center gap-4">
          {value.length > 0 &&
            !dontShowPreview &&
            value.map((imageUrl) => (
              <div key={imageUrl} className="relative w-[200px] min-h-[100px] max-h-[200px]">
                {/* Delete image btn */}
                ...
                {/* Image */}
                <Image fill className="object-cover rounded-md" alt="" src={imageUrl} />
              </div>
            ))}
        </div>
        <CldUploadWidget
